        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {[
              ...
              <article key={p.title} data-testid={`home-work-${i}`} className="group relative rounded-2xl overflow-hidden border border-white/5">
      ...
      <section className="max-w-7xl mx-auto px-6 lg:px-10 py-24">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {[
            ...
            <blockquote key={t.name} data-testid={`testimonial-${i}`} className="glass-card rounded-2xl p-7">
