  ...
  return (
    <footer data-testid="site-footer" className="border-t border-white/5 mt-24">
      <div className="max-w-7xl mx-auto px-6 lg:px-10 py-10 flex flex-col md:flex-row items-start md:items-center justify-between gap-6">
        <div>
          <div className="flex items-center gap-3">
            <span className="logo-tile" style={{ width: 38, height: 38 }}>
              <img
                src="https://customer-assets.emergentagent.com/job_webpage-replica-tool/artifacts/iy6st2rv_IMG_0512.jpg"
                alt="Amorevia Media"
              />
            ...
            <div className="flex flex-col leading-none">
              <span className="font-[Outfit] font-extrabold tracking-[0.18em] text-white text-base">AMOREVIA</span>
              <span className="text-[0.62rem] tracking-[0.32em] text-[#8D8D8D] mt-1">MEDIA AGENCY</span>
            </div>
          </div>
          <p className="text-xs text-slate-500 mt-3">© 2025 Amoreviamediaagency. All rights reserved.</p>
        </div>
